...
MINOR_LEN = 4.0
MINOR_W = 2
# Tick spacing: major ticks carry the labels, minor ticks sit in between
GFP_MAJOR = 1000
GFP_MINOR = 500
MKATE_MAJOR = 10000
MKATE_MINOR = 5000
...
def save_all_groups_mirrored_dual_plot(df, output_dir, tf_order, group_palette):
    ...
    if gfp_summary.empty:
        print("Skipping mirror plot: gfp_summary is empty")
        return
    ...
    # Bottom panel: mKate, mirrored downwards
...
print(f"Analysis complete. Results saved to: {OUTPUT_DIR.resolve()}")