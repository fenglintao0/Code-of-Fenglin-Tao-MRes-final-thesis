...
TFBS_PATH = "Sequence/CMVp_IE_top hits TF.xlsx"  # 支持.xlsx 或.csv
...
fig_height = max(4, 0.45 * len(unique_tfs))  # 每个 TF 行多一点高度
...
# 手动设置 Y 轴范围，防止顶部的文字被标题遮挡
# 下限设为 -1 (给底部留空)
# 上限设为 len(unique_tfs) (给顶部留空，因为最大的 index 是 len-1)
